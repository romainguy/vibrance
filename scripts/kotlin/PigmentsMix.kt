// Optimized implementation of Kubelka-Munk pigments mixing in Kotlin
// This uses the two-constant extension to account for a substrate
fun pigmentsMix(
    blue: Float,
    magenta: Float,
    yellow: Float,
    ...
    color[0] = oetfSrgb(linearR).fastCoerceIn(0.0f, 1.0f)
    color[1] = oetfSrgb(linearG).fastCoerceIn(0.0f, 1.0f)
    color[2] = oetfSrgb(linearB).fastCoerceIn(0.0f, 1.0f)
...
// 3-degree polynomial fit of the pigments mix function, computed using fit.py
@Suppress("FloatingPointLiteralPrecision")
fun polynomialPigmentsMix(
    blue: Float,
    magenta: Float,
    yellow: Float,
    white: Float,
