...
class Pigments():
    ...
    def mix_as_curve(self, concentration):
        ...
        return np.clip(np.array([
              0.0046860 - 0.8237521 * c0 + 0.2701260 * c1 + 0.2497449 * c2
            + 0.3038781 * c3 + 1.3655877 * c0**2 - 0.5825365 * c0 * c1 - 0.7746879 * c0 * c2
            - 0.8321140 * c0 * c3 + 0.1325372 * c1**2 + 0.3005471 * c1 * c2 + 0.4195783 * c1 * c3
            + 0.1655366 * c2**2 + 0.5583500 * c2 * c3 + 0.1580595 * c3**2,
                0.2153393 - 0.0589833 * c0 - 0.2969622 * c1 + 0.1277088 * c2
            + 0.2282331 * c3 + 0.0992048 * c0**2 + 0.2202922 * c0 * c1 - 0.2161089 * c0 * c2
            - 0.1623694 * c0 * c3 + 0.2537275 * c1**2 - 0.3932092 * c1 * c2 - 0.3777686 * c1 * c3
            + 0.2658333 * c2**2 + 0.4711941 * c2 * c3 + 0.2971778 * c3**2,
                0.2393674 + 0.2458887 * c0 + 0.2167258 * c1 - 0.7417349 * c2
            + 0.2791151 * c3 + 0.1444178 * c0**2 + 0.1570984 * c0 * c1 - 0.5000599 * c0 * c2
            + 0.4444324 * c0 * c3 + 0.0412092 * c1**2 - 0.2898977 * c1 * c2 + 0.3083201 * c1 * c3
            + 0.7873337 * c2**2 - 0.7390956 * c2 * c3 + 0.2654563 * c3**2,
        ]), 0, 1)
